/*
A driver for the go-strm library, that provides the APPEND command.
...
Or:
	...
	import (
		_ "github.com/reiver/strm-append"
	)

If you use the 1st style -- the dot import -- then the APPEND constant will be made available,
